...
public class GoodsInfoActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void Eventbusm(EventbusMessage eventbusMessage){
        String cover_price = eventbusMessage.getCover_price();
        String figure = eventbusMessage.getFigure();
        String name = eventbusMessage.getName();
        String product_id = eventbusMessage.getProduct_id();
